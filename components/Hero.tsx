...
const SocialHub = () => (
  ...
  >
    ...
    <motion.a 
      ...
      whileHover="hover"
      animate="rest"
      className="inline-flex items-center gap-4 bg-gg-medium/50 backdrop-blur-md border border-gray-700 rounded-lg p-2 pr-6 group transition-all cursor-pointer shadow-lg hover:shadow-[0_0_20px_rgba(0,217,255,0.2)] hover:border-gg-cyan/50 hover:bg-gg-medium/80 w-full sm:w-auto justify-center sm:justify-start"
    >
      <motion.div 
    ...
    <div className="flex flex-row gap-2 w-full sm:w-auto">
      <a href={INSTA_LINK} target="_blank" rel="noopener noreferrer" className="flex-1 sm:flex-none flex items-center justify-center sm:justify-start gap-3 px-4 py-2 bg-gg-medium/50 border border-gray-700 rounded-lg hover:border-gg-pink/50 hover:bg-gg-pink/5 group transition-all">
      ...
      <a href={YT_LINK} target="_blank" rel="noopener noreferrer" className="flex-1 sm:flex-none flex items-center justify-center sm:justify-start gap-3 px-4 py-2 bg-gg-medium/50 border border-gray-700 rounded-lg hover:border-red-500/50 hover:bg-red-500/5 group transition-all">
        <div className="shrink-0 transition-transform group-hover:scale-110">
            <YouTubeIcon />
        </div>
         <div className="flex flex-col">
...
export const Hero: React.FC = () => {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative min-h-[100svh] w-full overflow-hidden flex flex-col items-center bg-gg-dark"
    >
      ...
      <motion.div 
        ...
        className="container relative z-20 mx-auto px-4 md:px-8 xl:px-12 pt-28 md:pt-36 h-full flex flex-col justify-center items-center pb-20"
      >
        
        {/* CONTENT WRAPPER: SPLIT LAYOUT FOR TEXT & STATS */}
        <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 mb-12">
            ...
            <div className="w-full lg:w-3/5 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
                ...
                <div className="mb-6 relative z-30">
                    <GlitchTextWrapper>
                        {/* Responsive typography scaling: text-4xl on mobile, 6xl on tablet, 8xl on laptop, 9xl on desktop */}
                        <h1 className="text-4xl sm:text-6xl lg:text-8xl xl:text-9xl font-heading font-black text-white leading-[0.9] tracking-tighter italic drop-shadow-2xl">
                            PUNE'S
                        </h1>
                    </GlitchTextWrapper>
                    <div className="h-2 md:h-4" /> 
                    <GlitchTextWrapper>
                        <h1 className="text-4xl sm:text-6xl lg:text-8xl xl:text-9xl font-heading font-black text-transparent bg-clip-text bg-gradient-to-r from-gg-cyan via-white to-gg-cyan leading-[0.9] tracking-tighter italic pb-2 pr-4 drop-shadow-[0_0_30px_rgba(0,217,255,0.4)]">
                            RANKED HQ
                        </h1>
                    </GlitchTextWrapper>
                </div>
            ...
            <div className="flex w-full lg:w-2/5 h-full items-center justify-center lg:justify-end">
                <motion.div 
